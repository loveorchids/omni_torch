...
import omni_torch.networks.train as omth_train
...
class CifarNet(nn.Module):
    def __init__(self):
        ...
        self.conv_block2 = omth_blocks.conv_block(input=32, filters=[64, 64], kernel_sizes=[3, 3],
                                                  stride=[1, 1], padding=[1, 1], batch_norm=False)
        self.fc_layer1 = nn.Linear(4096, 512)
...
if __name__ == "__main__":
    ...
    for epoch in range(args.epoch_num):
        ...
        fit(net, args, train_set, device, optimizer, criterion)
        evaluation(net, args, test_set, device, optimizer, criterion)
